...
<?php echo $this->Form->create('TipoCargo'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Tipo Cargo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TipoCargo.tipo_cargo_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TipoCargo.tipo_cargo_id'))); ?></li>
