<div class="partidos index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $partido['Partido']['partido_id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $partido['Partido']['partido_id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $partido['Partido']['partido_id']), null, __('Are you sure you want to delete # %s?', $partido['Partido']['partido_id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
