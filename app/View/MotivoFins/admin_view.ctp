<div class="motivoFins view">
<h2><?php  echo __('Motivo Fin'); ?></h2>
	<dl>
		<dt><?php echo __('Motivo Fin Id'); ?></dt>
		<dd>
			<?php echo h($motivoFin['MotivoFin']['motivo_fin_id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Motivo'); ?></dt>
		<dd>
			<?php echo h($motivoFin['MotivoFin']['motivo']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Motivo Fin'), array('action' => 'edit', $motivoFin['MotivoFin']['motivo_fin_id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Motivo Fin'), array('action' => 'delete', $motivoFin['MotivoFin']['motivo_fin_id']), null, __('Are you sure you want to delete # %s?', $motivoFin['MotivoFin']['motivo_fin_id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($motivoFin['Cargo'] as $cargo): ?>
		<tr>
